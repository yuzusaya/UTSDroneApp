...
public class MainActivity extends FragmentActivity implements View.OnClickListener, GoogleMap.OnMapClickListener, OnMapReadyCallback {
    ...
    private Button config, upload, start, stop, camera;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      model = pass.getStringExtra("pass");
    ...
    public class callAPI extends AsyncTask<List,Void, String> {
